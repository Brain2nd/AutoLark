...
def GET_LOGIN_CODE_CMD():
    parser = argparse.ArgumentParser(description='获取登录代码。')
    parser.add_argument('-r', '--redirect_uri', help='重定向URL')
    parser.add_argument('-a', '--app_id', help='应用ID')
    parser.add_argument('-c', '--config_file', help='配置文件路径')
